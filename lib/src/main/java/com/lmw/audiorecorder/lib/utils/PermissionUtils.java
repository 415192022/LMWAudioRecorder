package com.lmw.audiorecorder.lib.utils;
...
public class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(AudioRecorder.getApp().getPackageName());
    }
    ...
    public static List<String> getPermissions(final String packageName) {
        PackageManager pm = AudioRecorder.getApp().getPackageManager();
        try {
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(AudioRecorder.getApp(), permission);
    }
    ...
    public static void launchAppDetailsSettings() {
        ...
        intent.setData(Uri.parse("package:" + AudioRecorder.getApp().getPackageName()));
        AudioRecorder.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(AudioRecorder.getApp());
    }
